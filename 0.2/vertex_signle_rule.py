...
Date: 2022-03-31 07:41:34
LastEditTime: 2022-03-31 12:03:48
FilePath: \0328P-rete\vertex_signle_rule.py
'''
...
class Alpha:
    def __init__(self,pattern:str) ->None:
        ...
        self.adjacent_beta_node = None

    def set_adjacent_beta_node(self,beta_node_obj:object) ->None:
        self.adjacent_beta_node =beta_node_obj


class Beta:
    def __init__(self,left_node:object,right_node:object) -> None:
        self.pattern = None
        self.left_node_activated_state = False
        self.right_node_activated_state = False
